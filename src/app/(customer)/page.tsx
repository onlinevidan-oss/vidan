      ...
      <section className="relative my-14 overflow-hidden rounded-[16px] border border-ink-200 bg-white p-8 md:p-14">
        <div className="relative z-10">
          ...
          <p className="mb-4 max-w-[620px] text-[15px] leading-relaxed text-ink-700">
            ...
            технологийг нэвтрүүлэн эх орны үржил шимтэй хөрсөнд ургуулсан хүнсний
            ногоогоор “ВИДАН” брэндийн бүтээгдэхүүнийг үйлдвэрлэж эхэлсэн түүхтэй.
          </p>
          <p className="mb-7 max-w-[620px] text-[15px] leading-relaxed text-ink-700">
            ВИДАН брэнд эх орондоо үндэсний үйлдвэрлэлийг хөгжүүлж, ажлын байр
            нэмэгдүүлэн, олон улсын болон Европ стандартыг нутагшуулснаар амин
            дэмээр баялаг хүнсний ногоо, жимс жимсгэний 20 гаруй нэрийн 30 орчим
            төрлийн бүтээгдэхүүн үйлдвэрлэж, хэрэглэгчдэдээ нийлүүлж байна.
          </p>
          <Link
            href="/about"
